...
const intro = magpieViews.view_generator("intro", {
    ...
    text: `Welcome to this great experiment.
            <br />
            <br />
            It's the best experiment that was ever conducted. It's great, and beautiful, and really great. All other experiments are total loosers. 
            <br />
            <br />
            And the best thing: You can be a part of it. With your participation we can make experiments great again.`,
...
const instructions_practice = magpieViews.view_generator("instructions", {
    ...
    text:  `You will see pictures showing pairs of geometrical objects. Your task is to compare both objects and decide 
			whether they are the same (expect for their orientation) or different.
			<br />
			<br />
			Press button 'F' if the objects are the same.
			<br />
			Press button 'J' if the objects are different.
            <br />
            <br />
...
const instructions_main = magpieViews.view_generator("instructions", {
    ...
    text:  `We will now proceed to the main experiment.
			<br />
			<br />
			Please try to answer as fast and accurately as possible!`,
    buttonText: 'begin'
});
